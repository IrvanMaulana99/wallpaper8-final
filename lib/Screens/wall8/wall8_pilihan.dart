...
Future<void> wall8atur(
    {@required BuildContext context, @required String imgUrl}) async {
  var actionSheet = CupertinoActionSheet(
    title: Text('Atur Wallpaper sebagai'),
    actions: [
  ...
  if (option != null) {
    var cachedImage = await DefaultCacheManager().getSingleFile(imgUrl);
